...
screen main_menu():
    ...
    imagemap:
        ...
        hotspot(848, 140, 267, 73) action Start()
        hotspot(774, 268, 406, 73) action ShowMenu("load")
        hotspot(792, 396, 359, 73) action ShowMenu('preferences')
        hotspot(858, 860, 230, 73) action Quit(confirm=True)
